...
// ------------------------
	/*@SWIG:OTAPI.i,337,OT_CONTAINER_TYPE_MEMBERS@*/
	private List elementList = new ArrayList();
/*@SWIG@*/
	/*@SWIG:OTAPI.i,418,OT_ADD_ELEMENT@*/  // THIS BLOCK CONTAINS JAVA CODE.
...
/*@SWIG@*/
  ...
  public OfferDataMarket GetBidData(long nIndex) {
  ...
  public boolean AddBidData(OfferDataMarket disownObject) {
    return otapiJNI.OfferListMarket_AddBidData(swigCPtr, this, OfferDataMarket.getCPtr(disownObject), disownObject);
  }

  public long GetAskDataCount() { return otapiJNI.OfferListMarket_GetAskDataCount(swigCPtr, this); }

  public OfferDataMarket GetAskData(long nIndex) {
  ...
  public boolean AddAskData(OfferDataMarket disownObject) {
    return otapiJNI.OfferListMarket_AddAskData(swigCPtr, this, OfferDataMarket.getCPtr(disownObject), disownObject);
  }
