...
SWIGEXPORT void Init_otapi(void) {
  ...
  rb_define_module_function(mOtapi, "OT_API_SwitchWallet", _wrap_OT_API_SwitchWallet, -1);
  rb_define_module_function(mOtapi, "OT_API_GetMemlogSize", _wrap_OT_API_GetMemlogSize, -1);
  rb_define_module_function(mOtapi, "OT_API_GetMemlogAtIndex", _wrap_OT_API_GetMemlogAtIndex, -1);
  rb_define_module_function(mOtapi, "OT_API_PeekMemlogFront", _wrap_OT_API_PeekMemlogFront, -1);
  rb_define_module_function(mOtapi, "OT_API_PeekMemlogBack", _wrap_OT_API_PeekMemlogBack, -1);
  rb_define_module_function(mOtapi, "OT_API_PopMemlogFront", _wrap_OT_API_PopMemlogFront, -1);
  rb_define_module_function(mOtapi, "OT_API_PopMemlogBack", _wrap_OT_API_PopMemlogBack, -1);
  rb_define_module_function(mOtapi, "OT_API_CreateNym", _wrap_OT_API_CreateNym, -1);
  rb_define_module_function(mOtapi, "OT_API_AddServerContract", _wrap_OT_API_AddServerContract, -1);
  rb_define_module_function(mOtapi, "OT_API_AddAssetContract", _wrap_OT_API_AddAssetContract, -1);
  ...
  rb_define_module_function(mOtapi, "OT_API_GetNym_OutmailCount", _wrap_OT_API_GetNym_OutmailCount, -1);
  rb_define_module_function(mOtapi, "OT_API_GetNym_OutmailContentsByIndex", _wrap_OT_API_GetNym_OutmailContentsByIndex, -1);
  rb_define_module_function(mOtapi, "OT_API_GetNym_OutmailRecipientIDByIndex", _wrap_OT_API_GetNym_OutmailRecipientIDByIndex, -1);
  rb_define_module_function(mOtapi, "OT_API_GetNym_OutmailServerIDByIndex", _wrap_OT_API_GetNym_OutmailServerIDByIndex, -1);
  rb_define_module_function(mOtapi, "OT_API_Nym_RemoveOutmailByIndex", _wrap_OT_API_Nym_RemoveOutmailByIndex, -1);
  rb_define_module_function(mOtapi, "OT_API_Nym_VerifyOutmailByIndex", _wrap_OT_API_Nym_VerifyOutmailByIndex, -1);
  rb_define_module_function(mOtapi, "OT_API_Wallet_CanRemoveServer", _wrap_OT_API_Wallet_CanRemoveServer, -1);
  rb_define_module_function(mOtapi, "OT_API_Wallet_RemoveServer", _wrap_OT_API_Wallet_RemoveServer, -1);
  rb_define_module_function(mOtapi, "OT_API_Wallet_CanRemoveAssetType", _wrap_OT_API_Wallet_CanRemoveAssetType, -1);
  rb_define_module_function(mOtapi, "OT_API_Wallet_RemoveAssetType", _wrap_OT_API_Wallet_RemoveAssetType, -1);
  rb_define_module_function(mOtapi, "OT_API_Wallet_CanRemoveNym", _wrap_OT_API_Wallet_CanRemoveNym, -1);
  ...
  rb_define_module_function(mOtapi, "OT_API_SetServer_Name", _wrap_OT_API_SetServer_Name, -1);
  rb_define_module_function(mOtapi, "OT_API_VerifyAndRetrieveXMLContents", _wrap_OT_API_VerifyAndRetrieveXMLContents, -1);
  rb_define_module_function(mOtapi, "OT_API_WriteCheque", _wrap_OT_API_WriteCheque, -1);
  rb_define_module_function(mOtapi, "OT_API_WritePaymentPlan", _wrap_OT_API_WritePaymentPlan, -1);
  rb_define_module_function(mOtapi, "OT_API_LoadUserPubkey", _wrap_OT_API_LoadUserPubkey, -1);
  rb_define_module_function(mOtapi, "OT_API_LoadPubkey", _wrap_OT_API_LoadPubkey, -1);
  ...
  rb_define_module_function(mOtapi, "OT_API_Basket_GetMinimumTransferAmount", _wrap_OT_API_Basket_GetMinimumTransferAmount, -1);
  rb_define_module_function(mOtapi, "OT_API_Basket_GetMemberMinimumTransferAmount", _wrap_OT_API_Basket_GetMemberMinimumTransferAmount, -1);
  ...
  rb_define_module_function(mOtapi, "OT_API_Ledger_FinalizeResponse", _wrap_OT_API_Ledger_FinalizeResponse, -1);
  ...
  rb_define_module_function(mOtapi, "OT_API_CreatePurse", _wrap_OT_API_CreatePurse, -1);
  rb_define_module_function(mOtapi, "OT_API_SavePurse", _wrap_OT_API_SavePurse, -1);
  rb_define_module_function(mOtapi, "OT_API_Purse_GetTotalValue", _wrap_OT_API_Purse_GetTotalValue, -1);
  rb_define_module_function(mOtapi, "OT_API_Purse_Count", _wrap_OT_API_Purse_Count, -1);
  rb_define_module_function(mOtapi, "OT_API_Purse_Peek", _wrap_OT_API_Purse_Peek, -1);
  rb_define_module_function(mOtapi, "OT_API_Purse_Pop", _wrap_OT_API_Purse_Pop, -1);
  ...
  rb_define_module_function(mOtapi, "OT_API_Token_GetValidFrom", _wrap_OT_API_Token_GetValidFrom, -1);
  rb_define_module_function(mOtapi, "OT_API_Token_GetValidTo", _wrap_OT_API_Token_GetValidTo, -1);
  rb_define_module_function(mOtapi, "OT_API_Token_GetAssetID", _wrap_OT_API_Token_GetAssetID, -1);
  rb_define_module_function(mOtapi, "OT_API_Token_GetServerID", _wrap_OT_API_Token_GetServerID, -1);
  ...
  rb_define_module_function(mOtapi, "OT_API_sendUserMessage", _wrap_OT_API_sendUserMessage, -1);
  ...
  rb_define_module_function(mOtapi, "OT_API_GenerateBasketCreation", _wrap_OT_API_GenerateBasketCreation, -1);
  rb_define_module_function(mOtapi, "OT_API_AddBasketCreationItem", _wrap_OT_API_AddBasketCreationItem, -1);
  rb_define_module_function(mOtapi, "OT_API_issueBasket", _wrap_OT_API_issueBasket, -1);
  rb_define_module_function(mOtapi, "OT_API_GenerateBasketExchange", _wrap_OT_API_GenerateBasketExchange, -1);
  rb_define_module_function(mOtapi, "OT_API_AddBasketExchangeItem", _wrap_OT_API_AddBasketExchangeItem, -1);
  ...
  rb_define_module_function(mOtapi, "OT_API_getOutbox", _wrap_OT_API_getOutbox, -1);
  rb_define_module_function(mOtapi, "OT_API_getNymbox", _wrap_OT_API_getNymbox, -1);
  rb_define_module_function(mOtapi, "OT_API_LoadNymbox", _wrap_OT_API_LoadNymbox, -1);
  rb_define_module_function(mOtapi, "OT_API_processInbox", _wrap_OT_API_processInbox, -1);
  rb_define_module_function(mOtapi, "OT_API_processNymbox", _wrap_OT_API_processNymbox, -1);
  ...
  rb_define_module_function(mOtapi, "OT_API_depositPaymentPlan", _wrap_OT_API_depositPaymentPlan, -1);
  rb_define_module_function(mOtapi, "OT_API_issueMarketOffer", _wrap_OT_API_issueMarketOffer, -1);
  rb_define_module_function(mOtapi, "OT_API_PopMessageBuffer", _wrap_OT_API_PopMessageBuffer, -1);
  ...
  rb_define_module_function(mOtapi, "OT_API_Message_GetTransactionSuccess", _wrap_OT_API_Message_GetTransactionSuccess, -1);
  ...
  rb_define_module_function(mOtapi, "OT_API_Message_GetNewIssuerAcctID", _wrap_OT_API_Message_GetNewIssuerAcctID, -1);
  rb_define_module_function(mOtapi, "OT_API_Message_GetNewAcctID", _wrap_OT_API_Message_GetNewAcctID, -1);
