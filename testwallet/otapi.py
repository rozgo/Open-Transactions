...
def OT_API_cancelNymMarketOffer(*args):
  return _otapi.OT_API_cancelNymMarketOffer(*args)
OT_API_cancelNymMarketOffer = _otapi.OT_API_cancelNymMarketOffer

def OT_API_getOffer_Trades(*args):
  return _otapi.OT_API_getOffer_Trades(*args)
OT_API_getOffer_Trades = _otapi.OT_API_getOffer_Trades
...
STORED_OBJ_OFFER_DATA_MARKET = _otapi.STORED_OBJ_OFFER_DATA_MARKET
