...
public class otapi {
  ...
  public static void OT_API_getMarketRecentTrades(string SERVER_ID, string USER_ID, string MARKET_ID, string MAX_DEPTH) {
    otapiPINVOKE.OT_API_getMarketRecentTrades(SERVER_ID, USER_ID, MARKET_ID, MAX_DEPTH);
  }
  ...
  public static void OT_API_cancelNymMarketOffer(string SERVER_ID, string USER_ID, string TRANSACTION_NUMBER) {
    otapiPINVOKE.OT_API_cancelNymMarketOffer(SERVER_ID, USER_ID, TRANSACTION_NUMBER);
  }

  public static void OT_API_getOffer_Trades(string SERVER_ID, string USER_ID, string TRANSACTION_NUMBER) {
    otapiPINVOKE.OT_API_getOffer_Trades(SERVER_ID, USER_ID, TRANSACTION_NUMBER);
  }
