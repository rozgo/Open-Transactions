...
*OT_API_cancelNymMarketOffer = *otapic::OT_API_cancelNymMarketOffer;
*OT_API_getOffer_Trades = *otapic::OT_API_getOffer_Trades;
...
*STORED_OBJ_OFFER_DATA_MARKET = *otapic::STORED_OBJ_OFFER_DATA_MARKET;
