...
public class TradeDataMarket : Displayable {
  ...
  public SWIGTYPE_p_uint64_t transaction_id {
    set {
      otapiPINVOKE.TradeDataMarket_transaction_id_set(swigCPtr, SWIGTYPE_p_uint64_t.getCPtr(value));
      if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      SWIGTYPE_p_uint64_t ret = new SWIGTYPE_p_uint64_t(otapiPINVOKE.TradeDataMarket_transaction_id_get(swigCPtr), true);
      if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }
  ...
  public SWIGTYPE_p_uint32_t date {
    set {
      otapiPINVOKE.TradeDataMarket_date_set(swigCPtr, SWIGTYPE_p_uint32_t.getCPtr(value));
      if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      SWIGTYPE_p_uint32_t ret = new SWIGTYPE_p_uint32_t(otapiPINVOKE.TradeDataMarket_date_get(swigCPtr), true);
      if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }
  ...
  public SWIGTYPE_p_uint64_t price {
    set {
      otapiPINVOKE.TradeDataMarket_price_set(swigCPtr, SWIGTYPE_p_uint64_t.getCPtr(value));
      if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      SWIGTYPE_p_uint64_t ret = new SWIGTYPE_p_uint64_t(otapiPINVOKE.TradeDataMarket_price_get(swigCPtr), true);
      if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }
  ...
  public SWIGTYPE_p_uint64_t amount_sold {
    set {
      otapiPINVOKE.TradeDataMarket_amount_sold_set(swigCPtr, SWIGTYPE_p_uint64_t.getCPtr(value));
      if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      SWIGTYPE_p_uint64_t ret = new SWIGTYPE_p_uint64_t(otapiPINVOKE.TradeDataMarket_amount_sold_get(swigCPtr), true);
      if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }
