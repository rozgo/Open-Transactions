...
abstract class otapi {
	...
	static function OT_API_getMarketRecentTrades($SERVER_ID,$USER_ID,$MARKET_ID,$MAX_DEPTH) {
		OT_API_getMarketRecentTrades($SERVER_ID,$USER_ID,$MARKET_ID,$MAX_DEPTH);
	}
	...
	static function OT_API_cancelNymMarketOffer($SERVER_ID,$USER_ID,$TRANSACTION_NUMBER) {
		OT_API_cancelNymMarketOffer($SERVER_ID,$USER_ID,$TRANSACTION_NUMBER);
	}

	static function OT_API_getOffer_Trades($SERVER_ID,$USER_ID,$TRANSACTION_NUMBER) {
		OT_API_getOffer_Trades($SERVER_ID,$USER_ID,$TRANSACTION_NUMBER);
	}
	...
	const STORED_OBJ_OFFER_DATA_MARKET = STORED_OBJ_OFFER_DATA_MARKET;
