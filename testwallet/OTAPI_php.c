...
static function_entry otapi_functions[] = {
 ...
 ZEND_NAMED_FE(ot_api_switchwallet,_wrap_OT_API_SwitchWallet,NULL)
 ZEND_NAMED_FE(ot_api_getmemlogsize,_wrap_OT_API_GetMemlogSize,NULL)
 ZEND_NAMED_FE(ot_api_getmemlogatindex,_wrap_OT_API_GetMemlogAtIndex,NULL)
 ZEND_NAMED_FE(ot_api_peekmemlogfront,_wrap_OT_API_PeekMemlogFront,NULL)
 ZEND_NAMED_FE(ot_api_peekmemlogback,_wrap_OT_API_PeekMemlogBack,NULL)
 ZEND_NAMED_FE(ot_api_popmemlogfront,_wrap_OT_API_PopMemlogFront,NULL)
 ZEND_NAMED_FE(ot_api_popmemlogback,_wrap_OT_API_PopMemlogBack,NULL)
 ...
 ZEND_NAMED_FE(ot_api_verifyaccountreceipt,_wrap_OT_API_VerifyAccountReceipt,NULL)
 ...
 ZEND_NAMED_FE(ot_api_getnym_outmailcount,_wrap_OT_API_GetNym_OutmailCount,NULL)
 ZEND_NAMED_FE(ot_api_getnym_outmailcontentsbyindex,_wrap_OT_API_GetNym_OutmailContentsByIndex,NULL)
 ZEND_NAMED_FE(ot_api_getnym_outmailrecipientidbyindex,_wrap_OT_API_GetNym_OutmailRecipientIDByIndex,NULL)
 ZEND_NAMED_FE(ot_api_getnym_outmailserveridbyindex,_wrap_OT_API_GetNym_OutmailServerIDByIndex,NULL)
 ZEND_NAMED_FE(ot_api_nym_removeoutmailbyindex,_wrap_OT_API_Nym_RemoveOutmailByIndex,NULL)
 ZEND_NAMED_FE(ot_api_nym_verifyoutmailbyindex,_wrap_OT_API_Nym_VerifyOutmailByIndex,NULL)
 ...
 ZEND_NAMED_FE(ot_api_createpurse,_wrap_OT_API_CreatePurse,NULL)
 ZEND_NAMED_FE(ot_api_savepurse,_wrap_OT_API_SavePurse,NULL)
 ZEND_NAMED_FE(ot_api_purse_gettotalvalue,_wrap_OT_API_Purse_GetTotalValue,NULL)
 ZEND_NAMED_FE(ot_api_purse_count,_wrap_OT_API_Purse_Count,NULL)
 ZEND_NAMED_FE(ot_api_purse_peek,_wrap_OT_API_Purse_Peek,NULL)
 ZEND_NAMED_FE(ot_api_purse_pop,_wrap_OT_API_Purse_Pop,NULL)
 ZEND_NAMED_FE(ot_api_purse_push,_wrap_OT_API_Purse_Push,NULL)
 ZEND_NAMED_FE(ot_api_wallet_importpurse,_wrap_OT_API_Wallet_ImportPurse,NULL)
 ZEND_NAMED_FE(ot_api_exchangepurse,_wrap_OT_API_exchangePurse,NULL)
 ZEND_NAMED_FE(ot_api_token_changeowner,_wrap_OT_API_Token_ChangeOwner,NULL)
 ZEND_NAMED_FE(ot_api_token_getid,_wrap_OT_API_Token_GetID,NULL)
 ZEND_NAMED_FE(ot_api_token_getdenomination,_wrap_OT_API_Token_GetDenomination,NULL)
 ZEND_NAMED_FE(ot_api_token_getseries,_wrap_OT_API_Token_GetSeries,NULL)
 ZEND_NAMED_FE(ot_api_token_getvalidfrom,_wrap_OT_API_Token_GetValidFrom,NULL)
 ZEND_NAMED_FE(ot_api_token_getvalidto,_wrap_OT_API_Token_GetValidTo,NULL)
 ZEND_NAMED_FE(ot_api_token_getassetid,_wrap_OT_API_Token_GetAssetID,NULL)
 ZEND_NAMED_FE(ot_api_token_getserverid,_wrap_OT_API_Token_GetServerID,NULL)
 ...
 ZEND_NAMED_FE(ot_api_message_gettransactionsuccess,_wrap_OT_API_Message_GetTransactionSuccess,NULL)
